// DeepSeek Harness fork modification: serve the 0.1.6 Plugins seat through settingsScope.
/**
...
function apply(ctx: ClientCtx): void {
  ...
  //   - the settingsScope generation binds the Host-served namespace;
  //     its older Settings seat and newer Plugins-page seat are mutually
  //     exclusive across supported releases;
  ...
  ctx.inject(['settingsScope'], (raw) => {
    ...
    c.slots.inject('plugins.bundle.config', () => c.slots.register(
