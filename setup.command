...
DSH_AGENT_TEAMS_ARTIFACT=$SCRIPT_DIR/fork-plugins/releases/nanmicoder-dsh-agent-teams-0.1.16-dsh015alpha2.1.tgz
DSH_CONTEXT_ARTIFACT=$SCRIPT_DIR/fork-plugins/releases/dsh-context-0.41.3-dsh013alpha2.1.tgz
DSH_AGENT_TEAMS_SHA256=E2BD90AD8823CE95CD2D256BD51522B2C6B51C78E4E7DCD97B585AFF0D652A75
...
tar -xOzf "$DSH_AGENT_TEAMS_ARTIFACT" package/package.json \
  | node "$DSH_SETUP_HELPER" verify-manifest \
    '@nanmicoder/dsh-agent-teams' '0.1.16-dsh015alpha2.1'
