...
[Windows 子进程控制台决策](../architecture/2026-09-14-windows-subprocess-console-isolation.zh.md)拥有 Harness 命令使用的私有外层控制台启动方式。
