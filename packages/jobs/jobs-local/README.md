...
- **One terminal-expiry timer.** The registry arms one unreferenced timer for the nearest terminal deadline instead of retaining one timer per record; one expiry pass batches visible-set removal per owner.
