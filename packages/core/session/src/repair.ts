...
/** Model-facing recovery text for a tool call known not to have reached dispatch. */
...
/** Model-facing recovery text for a tool call whose side effects may have occurred. */
