...
describe('paging', () => {
  ...
  it('does not let a suspended old page clear a reopened generation loading state', async () => {
    ...
    api.onHistory = payload => payload.beforeSeq === undefined ? histResponse(tail, true) : oldPage.promise
    ...
    api.onHistory = payload => payload.beforeSeq === undefined ? histResponse(tail, true) : newPage.promise
