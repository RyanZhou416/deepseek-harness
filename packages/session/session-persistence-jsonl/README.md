...
| `coldLogMemoRetentionMs` | `10000` | Idle time a decoded log stays in the two-entry observe-to-resume memo; `0` disables reuse and may decode a current log twice per read handle |
