...
it('rejects drift in artifacts, profile pins, patches, and composed config', () => {
  ...
  try {
    const agentArtifact = join(root, 'nanmicoder-dsh-agent-teams-0.1.15-dsh013alpha2.1.tgz')
    ...
    writeFileSync(join(profile, 'pnpm-lock.yaml'), [
      'nanmicoder-dsh-agent-teams-0.1.15-dsh013alpha2.1.tgz',
      '0.1.15-dsh013alpha2.1',
