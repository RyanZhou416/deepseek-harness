...
One inbox feeds the driver. Wake messages start it; idle injections wait. Input admitted after the running driver's final inbox decision latches a replacement turn after convergence.
